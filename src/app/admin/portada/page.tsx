        ...
        <div className="min-h-screen bg-slate-50 dark:bg-slate-950 transition-colors duration-300">
            ...
            <div className="max-w-7xl mx-auto px-6 py-12">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
                    ...
                    <div className="bg-white dark:bg-slate-900 rounded-3xl shadow-xl border border-slate-200 dark:border-slate-800 p-8 animate-slide-up">
                        <div className="flex items-center gap-3 mb-8 pb-8 border-b border-slate-100 dark:border-slate-800">
                            ...
                            <div>
                                <h2 className="text-2xl font-bold text-slate-800 dark:text-slate-100">Editar Contenido</h2>
                                <p className="text-slate-500 dark:text-slate-400">Personaliza la primera impresión de tu tienda</p>
                            </div>
                        </div>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            <div className="space-y-2">
                                ...
                                <input
                                    ...
                                    className="w-full px-4 py-3 bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl focus:border-orange-500 focus:ring-4 focus:ring-orange-500/10 outline-none transition-all font-bold text-lg text-slate-800 dark:text-slate-100 placeholder-slate-400"
                                />
                            </div>
                            ...
                            <div className="space-y-2">
                                ...
                                <textarea
                                    ...
                                    rows={3}
                                    className="w-full px-4 py-3 bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl focus:border-orange-500 focus:ring-4 focus:ring-orange-500/10 outline-none transition-all text-slate-600 dark:text-slate-300 resize-none"
                                />
                            </div>

                            <div className="space-y-2">
                                <label className="text-sm font-bold text-slate-700 dark:text-slate-300 mb-1 flex justify-between">
                                    Imagen de Fondo
                                    {portada && <span className="text-xs text-orange-600 dark:text-orange-400 font-normal">Imagen actual guardada</span>}
                                </label>
                                <div className={`relative border-2 border-dashed rounded-xl p-8 text-center transition-all ${imageFile ? 'border-orange-500 bg-orange-50 dark:bg-orange-900/10' : 'border-slate-300 dark:border-slate-700 hover:border-orange-400 hover:bg-slate-50 dark:hover:bg-slate-800 scale-100'}`}>
                                    <input
                                        type="file"
                                        accept="image/*"
                                    ...
                                    <div className="flex flex-col items-center justify-center">
                                        {imageFile ? (
                                            <>
                                                <Check size={48} className="text-orange-500 mb-4 bg-white dark:bg-slate-800 rounded-full p-2 shadow-sm" />
                                                <p className="font-bold text-orange-700 dark:text-orange-400 mb-1">Imagen Seleccionada</p>
                                                <p className="text-sm text-orange-600 dark:text-orange-500 truncate max-w-[200px]">{imageFile.name}</p>
                                            </>
                                        ) : (
                                            <>
                                                <Upload size={48} className="text-slate-300 dark:text-slate-600 mb-4" />
                                                <p className="font-bold text-slate-700 dark:text-slate-300 mb-1">Clic para subir imagen</p>
                                                <p className="text-sm text-slate-400 dark:text-slate-500">JPG, PNG (Max 5MB)</p>
                                            </>
                                        )}
                                    </div>
                                </div>
                            ...
                            <div className="flex items-center gap-3 p-4 bg-slate-50 dark:bg-slate-800 rounded-xl border border-slate-100 dark:border-slate-700 my-6">
                                <div className="relative inline-block w-12 h-6 transition duration-200 ease-in-out">
                                    ...
                                    <label
                                        htmlFor="activo"
                                        className={`block w-12 h-6 rounded-full cursor-pointer transition-colors duration-300 ${formData.activo ? 'bg-green-500' : 'bg-slate-300 dark:bg-slate-600'
                                            }`}
                                    ></label>
                                ...
                                <label htmlFor="activo" className="text-sm font-bold text-slate-700 dark:text-slate-200 cursor-pointer select-none">
                                    Mostrar en Home
