    ...
    const socials = [
        {
            ...
            href: 'https://api.whatsapp.com/send?phone=59173643433'
        },
        {
            name: 'Instagram',
    ...
    return (
        <div className="fixed bottom-4 right-4 z-50 flex flex-col items-center gap-4">
            ...
            <button
                onClick={toggleOpen}
                className={`
                    flex items-center justify-center w-14 h-14 rounded-full shadow-xl text-white transition-all duration-300 z-50
                    ${isOpen ? 'bg-slate-900 rotate-135' : 'bg-orange-500 hover:bg-orange-600 hover:scale-105'}
                `}
